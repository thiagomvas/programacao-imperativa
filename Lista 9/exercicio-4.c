...
int main() {
    ...
    char palavras[][TAMANHO_PALAVRA] = { "banana", "maçã", "laranja", "uva", "abacaxi", "melancia", "mamão", "morango", "tapioca", "limão", "pera", "kiwi", "ameixa", "goiaba", "cereja", "abacate", "caqui", "pitaya", "framboesa", "nectarina", "tangerina", "manga", "caju", "jabuticaba", "figo" };
