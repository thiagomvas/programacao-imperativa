...
float calcularCambio(float valor, float cambio)
{
    return valor * cambio;
}
...
void main()
{
    float cambioDolar, cambioEuro, valor;
    ...
    float dolar = calcularCambio(valor, cambioDolar);
    float euro = calcularCambio(valor, cambioEuro);
